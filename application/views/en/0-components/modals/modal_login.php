...
<?php $attributes = array(
    ...
    <div class="homepage_signupgroup--legacy container-fluid"> 
        ...
        <div class=""> 
            ...
            <a  target="_blank" 
                href="<?php echo site_url().'en/home/recovery';?> "
                class="cursor pull-right password-retrieve btn btn-link">
            <?php echo $this->lang->line('forgot_pass'); ?>
            </a>
        </div> 
        <button class="btn btn-primary col-lg-4 block-center login-button auth" style="position:relative;top:20px" name="commit" type="submit" value="request" d>
