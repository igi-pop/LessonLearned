...
<div  class="content-header" style="margin-top:100px;">
        <div class="container bcrumb-position" >
            <div class="clearfix">
                ...
                <i class="glyphicon glyphicon-menu-right"></i>                    
                <span class="bold" ><?php echo $this->lang->line('breakcrumbs_activation_success'); ?></span>
                </div>
                </div>
            </div>
        </div>
   ...
   <div class="clearfix">
    <div class="container transition challenge-container">    
        ...
        <div class="col-lg-12 track_contentList" style="text-align:center;min-width: 200px">
         <h3 class=" col-lg-12  bold color-green lobster"> <?php echo $this->lang->line('activation_title_success'); ?> </h3>
         
            <div class="small bold col-lg-12">
            <span class="zeta "><?php echo $this->lang->line('activation_desc_success'); ?></span>
            </div>
