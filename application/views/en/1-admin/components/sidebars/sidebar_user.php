 <!-- SIDEBAR START -->
        ...
        <div id="profile-settings-sidebar" class="col-lg-3">
            <section class="clearfix">
                <img id="img-avatar" class="avatar block-center" src="<?php echo $user_info->avatar;?>" alt="igiruler" title="igiruler" width="150" height="150" >
                <button class="btn btn-small block-center margin-large " style="width:200px;" id="upload-avatar"><i class="icon--single icon-upload" ></i> Upload</button>
            </section>
            <div class="lg-block " id="profileTabs">
                <a class="lg-block_head  backbone <?php if($personal == 'active') echo "current";?>" id="profile" href="<?php echo base_url().'en/user/profile/settings/personal'; ?>" >Profile</a>
                <a class="lg-block_head  <?php if($avatar == 'active') echo "current";?>" id="school" href="<?php echo base_url().'en/user/profile/settings/avatar'; ?>" >Avatar</a>
