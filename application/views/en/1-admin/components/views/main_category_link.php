<div class="col-lg-4 col-lg-offset-2 col-md-6 col-sm-6 challenges-list" style="margin-top:25px">
            ...
            <section class="track_content-footer " >
				...
				<?php if(count($categories)): foreach($categories as $category): ?>
					...
					<tr style="text-align:center;">
						...
						<td><?php echo  anchor($language.'/admin/category/link/' . $category->category_id,  $category->category_name, 'class=" dark-limegreen-link bold"'); ?></td>
