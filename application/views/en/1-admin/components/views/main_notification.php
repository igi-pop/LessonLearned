...
<?php if($this->session->flashdata('error')) echo '<div class="alert alert-error  bold" style="text-align:center;" role="alert">'.$this->session->flashdata('error').'</div>'; ?>
...
<?php echo $flag_links; ?>
 ...
 <div class="pull-left title-h5">
         <div class="btn-group pull-right">
          <?php  echo $this->lang->line('note_notification_type');  ?><br />
<?php echo $type_links; ?>
</div>
</div>
...
<?php foreach($all_notifications as $notification): ?>
  ...
  <div class="col-lg-10 col-lg-offset-1 challenges-list note" style="margin-top:10px;padding-right:0px ">
          ...
          <section class="col-lg-12" style="padding:20px; padding-left:40px; padding-right:40px;" >
            <div class="row challengecard-title bold">
              <span class="pull-left challengecard-title  bold" style="margin-30px;">
                  <?php  echo $this->lang->line('note_applicant_info_title');  ?> 
                  <a href="<?php echo base_url().$language.'/admin/notification/view/'.$notification->note_id; ?>" class=" title-link" >
            ...
            <div class="row" style="margin-top:10px"><!-- Start oF "row" -->
    ...
    </div><!-- END OF "challenges-list" -->
    <div class="color-alt-grey note-submeni" >
      <a href="<?php echo base_url().$language.'/admin/notification/delete/'.$notification->note_id; ?>" 
        ...
        <i class="<?php echo $this->lang->line('popout_delete_icon'); ?>"></i>
      </a>
      <a href="<?php echo base_url().$language.'/admin/notification/view/'.$notification->note_id; ?>" title="<?php echo $this->lang->line('popout_view_title'); ?>" class="note-submeni-link">
  ...
  <div class="col-lg-10 col-lg-offset-1 challenges-list note" style="margin-top:10px;padding-right:0px ">
     ...
     <div class="color-alt-grey note-submeni" >
      <a href="<?php echo base_url().$language.'/admin/notification/delete/'.$notification->note_id; ?>" 
         onclick= "return confirm('<?php echo $this->lang->line('popout_confirm_delete'); ?>')" 
         title="<?php echo $this->lang->line('popout_delete_title'); ?>" class="note-submeni-link">
        <i class="<?php echo $this->lang->line('popout_delete_icon'); ?>"></i>
      </a>
      <a href="<?php echo base_url().$language.'/admin/notification/view/'.$notification->note_id; ?>" 
         title="<?php echo $this->lang->line('popout_view_title'); ?>" class="note-submeni-link">
        <i class="<?php echo $this->lang->line('popout_view_icon'); ?>"></i>
      </a>
    </div>
  <?php else: ?>
           ...
           <?php  if($notification->flag == 1) {?><img src="<?php echo  image_path('images/new_ribbon.png'); ?>" style="position:absolute;right:-4px;top:-4px;z-index:70 " /><?php } ?>
            <section class="col-lg-12" style="padding:20px; padding-left:40px; padding-right:40px;">
              ...
              <span class="pull-left challengecard-title  bold" style="margin-30px;">
               ...
               <a href="<?php echo base_url().$language.'/admin/notification/view/'.$notification->note_id; ?>" class="backbone title-link" >
                <?php echo $notification->lesson_name; ?></a> 
               <?php } ?>
                </span>
              <span class="pull-right "  style="font-size:14px;margin-left:30px;">
                <?php  echo $this->lang->line('note_notification_type');  ?>  
...
<div class="col-lg-6 col-lg-offset-3 alert alert-info center bold"><?php  echo $this->lang->line('note_no_notifications');  ?> </div>
</div>
