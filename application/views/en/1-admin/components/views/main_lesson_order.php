...
<!-- BUGFIX testirati protiv losi vrednosti koje ne postoje u abzi podataka ili nula -->


<div class="col-lg-6 col-lg-offset-3  challenges-list" style="margin-top:25px;margin-Bottom:100px">
      <h3><?php echo $this->lang->line('preview');  ?> Block editor:</h3>
      <h4><?php echo $this->lang->line('lessons_title');  ?> Check statistics
        <?php echo $lesson_name; ?><br />
        <?php echo $this->lang->line('lessons_slug');  ?> 
        <?php echo $lesson_slug; ?></h4>
	...
	<div class="content-text challenge-text mlB">
      ...
      <ul id="order" class="sortable ui-sortable">
        <?php foreach($direct_block as $block): 
          ...
          echo "<li id=\"item-".$block->block_id."\" class=\"col-lg-4 col-lg-offset-4 order-item\" style=\"background-color:#e5e5e5; padding:10px;\">".$block->title." (Block - ".$block->block_id.")</li>";
     ...
     echo "<h3><strong>".$this->lang->line('lessons_lesson_list')."</strong></h3>";
         ...
         <p style="font-size: 110px; text-shadow: 0 5px 20px rgba(0,0,0,0.4);" class="text-center col-lg-12 ">
          <strong><?php echo $this->lang->line('404');  ?></strong></p>     
