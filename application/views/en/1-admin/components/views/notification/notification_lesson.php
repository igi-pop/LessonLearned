...
<div class=" col-lg-12 settings-view" >
  <section id="settings-subview" class="profile">
    ...
    <h2>
      <?php  echo $this->lang->line('note_notification_type');  ?> 
      <?php echo "<span class=\"color-green bold\">".$this_notification->type_name; ?>
      <span class="pull-right color-dark" style="font-size:16px;">(<?php echo $this_notification->status; ?>)</span>
      <a href="<?php echo base_url($language.'/admin/notification/'); ?>" class="color-green pull-right" style="font-size:16px">
      ...
      <section class="row">
         <div class="col-lg-12 col-md-12" style="border-top:1px solid #2ec866;margin:35px;"></div>
      	<h3 class="color-alt-grey bold " style="clear:right"> 
        	<span class="bold " ><?php  echo $this->lang->line('note_notification_type_lesson');  ?></span>
        </h3>
         
    <div class="block col-lg-4 col-md-12">
...
<!-- color-alt-grey -->
     <div class="block col-lg-4 col-md-6" style="clear:right;">
    ...
    <div class="block col-lg-4 col-md-6 hidden-sm hidden-xs" style="clear:right;">
        <span class="color-dark bold" style="font-size:20px"><?php  echo $this->lang->line('note_lesson');  ?>
...
<!-- color-alt-grey -->
    ...
    <div class="block col-lg-4 col-md-6 hidden-sm hidden-xs" style="clear:right;">
     ...
     <div class="block col-lg-4 col-md-6 hidden-sm hidden-xs">
        <span class="color-dark bold" style="font-size:20px">
        	<span class="bold color-green" ></span>
        </span>
...
<!-- color-alt-grey -->
    ...
    <div class="block col-lg-4 col-md-6 hidden-sm hidden-xs" style="clear:right;">
        <span class="color-dark bold" style="font-size:20px"><?php  echo $this->lang->line('note_modified');  ?> 
...
<!-- color-alt-grey -->
    ...
    <div class="block col-lg-4 col-md-6 hidden-sm hidden-xs" style="clear:right;">
        <span class="color-dark bold" style="font-size:20px"><?php  echo $this->lang->line('note_approved');  ?> 
        	<span class="bold color-green" ><?php if($this_notification->lesson_a == 0 OR $this_notification->lesson_a == NULL){ echo $this->lang->line('note_no'); } else{ echo $this->lang->line('note_yes'); } ?></span>
        </span>
    </div>
...
<!-- color-alt-grey -->
     <div class="block col-lg-4 col-md-6 " style="clear:right;">
        <span class="color-dark bold" style="font-size:20px"> 
        	<a href="<?php echo base_url().$language.'/admin/lesson/view/'.$this_notification->category_id.'/'.$this_notification->course_id.'/'.$this_notification->lesson.'/' ?>" class="bold dark-limegreen-link" >LINK</a>
        </span>
    </div>
    <div class="block col-lg-4 col-md-6 hidden-sm hidden-xs" style="clear:right;">
        <span class="color-dark bold" style="font-size:20px">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="border-top:1px solid #2ec866;margin:15px;"></div>
    <div class="block col-lg-4 col-md-6 visible-sm-block visible-xs-block" style="clear:right;">
        <span class="color-dark bold" style="font-size:20px"><?php  echo $this->lang->line('note_lesson');  ?>
          <span class="bold color-green" ><?php echo $this_notification->lesson_name; ?></span>
        </span>
    </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 visible-sm-block visible-xs-block" style="border-top:1px solid #2ec866;margin:15px;"></div>
  </section>
...
<!-- color-alt-grey -->
    ...
    <div class="block col-lg-4" style="clear:right;">
     ...
     <div class="col-lg-12" style="border-top:1px solid #2ec866;margin:15px;"></div>
  </section>
...
<?php if($this_notification->flag != 3): ?>
      ...
      echo form_hidden('recive_id', $this_notification->send_id );
                          ...
                          echo form_hidden('name', $this_notification->lesson_name);
    ...
    <a class="btn btn-primary col-lg-2 col-lg-offset-1  " style="margin-top:60px;"  data-toggle="modal" data-target="#hr-dialog-response">
        ...
        <div class=\"hr-dialog-main-window \" style=\"background: transparent !important; position: relative;z-index:770\">
            ...
            <h2 class=\"color-green\"></h2>
                <div style=\"padding:25;padding-top:0px;\">
                    ...
                    <br />
                    <div class=\"row\">
                        <span class=\"bold\" style=\"padding:20px;margin-bottom:10px; font-size:16px\"> ".$this->lang->line('note_subject')." ".$this_notification->lesson_name."</span>
                        ";
