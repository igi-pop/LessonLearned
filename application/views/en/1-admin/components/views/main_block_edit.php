    ...
    <div  class=" track_content"  >
        ...
        <div class="col-md-11 col-lg-12 hr_tour-problem-statement problem-statement" >
	       ...
	       <div class="content-text challenge-text mlB">
            ...
            <?php echo form_open('/'.$language.'/admin/block/edit/'.$block_data[0]->block_id);?><br />
                    ...
                    <table class="table">
                        ...
                        <td><?php echo $this->lang->line('block_des');  ?></td>
                            <?php $array=array(
                                      ...
                                      'type'        =>  'text',
                                      'class'       =>  'col-lg-12 ',
                                      'value'       =>  $block_data[0]->description,
                                      );
                                      ?>
                        ...
                        <tr>
                            <td></td>
                            <td><a href="<?php echo base_url().$language.'/admin/lesson/view/'.$course_data[0]->category_id.'/'.$lesson_data[0]->course_id.'/'.$lesson_data[0]->lesson_id; ?>" class="btn btn-primary " style="margin-right:25px">
                              <?php echo $this->lang->line('go_back');  ?> </a>
                              <?php echo form_submit('submit', $this->lang->line('save'), 'class="btn btn-primary "'); ?>
                            </td>
                        </tr>
