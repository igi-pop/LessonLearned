  ...
  <div class="container-fluid" >
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
       ...
       <a href="<?php echo base_url().'en/home/' ?>" class="pull-left">
            <span class="lobster color-green bold" style="text-shadow: 1px 1px #007700;font-family: 'Candal', sans-serif;"><i class="glyphicon glyphicon-book"></i> Lesson Learned</span>
        </a>
    </div>
      ...
      <ul class="nav navbar-nav static-home-nav" >
       ...
       <li> 
        ...
        <li class="btn-green-display">
          ...
          <a href="<?php echo site_url('/en/home/login'); ?>" class="btn btn-flat btn-green"><?php echo $this->lang->line('btn_login'); ?> </a>
        </li>
        <li class="btn-green-display">
         
           <a href="<?php echo site_url('/en/home/signup'); ?>" class="btn btn-flat btn-green"> <?php echo $this->lang->line('btn_signup'); ?> </a>
        </li>
        <li class="dropdown ">
