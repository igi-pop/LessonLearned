  ...
  <div class="container-fluid" >
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
       ...
       <a href="<?php echo base_url().$language.'/home/' ?>" class="pull-left">
            <span class="lobster color-green bold" style="padding-top:10px;text-shadow: 1px 1px #007700;font-family: 'Candal', sans-serif;">
              <object type="image/svg+xml" data="<?php $icon = $this->lang->line('logo'); echo site_url($icon); ?>" class="logo" ><?php  echo $this->lang->line('nav_error_svg');  ?></object>
               
            <span class="logo-text"> Lesson Learned</span>
    ...
    <div class="collapse navbar-collapse  margin-mini" id="bs-example-navbar-collapse-1" >
      <ul class="nav navbar-nav static-home-nav" >
       ...
       <li style="z-index:190;" class="visible-xs-block">
        <span class=" col-xs-3 bold profile_label" ><?php  echo $this->lang->line('nav_user_profile');  ?></span>
          <a class="nav-avatar col-xs-9 profile_name_dark" href="<?php echo base_url().$language.'/user/profile/settings'; ?>" >
            <img src="<?php echo $nav_avatar; ?>" alt="User profile picture" class="avatar" style="width:30px; height:30px;" >
            <span class="mmR"><?php echo $nav_username; ?></span></a>
           </a>
        </li>
        

        <li class="<?php if(isset($navigation_dashboard_active)){ echo "active"; } ?> ">
          <a href="<?php echo base_url().$language.'/home/'; ?>" class=" static-link width-100">
            <i class="<?php  echo $this->lang->line('user_first_item_icon');  ?>"> </i> 
            <?php echo $this->lang->line('user_first_item'); ?>
       ...
       <li class="<?php if(isset($navigation_category_active)){ echo "active"; } ?>"> 
          <a class="static-link width-100" href="<?php echo base_url().$language.'/user/category/'; ?>">
            <i class="<?php  echo $this->lang->line('user_third_item_icon');  ?>"></i> 
            <?php echo $this->lang->line('user_third_item'); ?></a>
      </li>
      ...
      <?php endif; ?>
       ...
       <li class="visible-xs-block <?php if(isset($navigation_notification_active)){ echo "active"; } ?>"> 
          <a class="static-link width-100" href="<?php echo base_url().$language.'/user/search/';  ?>">
            <i class="<?php  echo $this->lang->line('nav_search_icon');  ?>"></i> 
            <?php echo $this->lang->line('nav_search'); ?></a>
      </li>
    ...
    <div class="search-placeholder col-lg-12 col-md-12 col-sm-12 hidden-xs hidden-sm" style="margin-top:15px">
      <?php 

      echo form_open($language.'/user/search/index/'.$this->input->post('search')); ?>
              <?php
            
             $data = array(
                      'name'        => 'search_mini_button',
                      'id'          => 'search',
                      'class'       => 'search-input ',
                      'value'       => true,
                    );
            ...
            echo form_hidden($data);
               $data = array(
                      ...
                      'type'        => 'text',
                      'size'        => '50',
                      'class'       => 'search-input col-lg-8 col-md-9 col-sm-9',
                    );
            ...
            <button name="search_mini_button"  class="btn  btn-primary search-button col-md-3 col-sm-3"><i class="glyphicon glyphicon-search"></i></button>
    <?php echo form_close(); ?>
        </div> 
    <li class="dropdown notification" style="">
        ...
        <li >
          <section class="color-alt-grey header-notification col-lg-12" >
            ...
            <span class="pull-right" href="#">
              <?php  echo $this->lang->line('right_link');  ?>
            </span>
          </section>
        </li>
        <?php  if(count($notifications)==0 OR $notifications==NULL){
          ...
          foreach($notifications as $notification): ?>
            <a href="<?php echo base_url().$language.'/user/profile/notification_details/'.$notification->note_id.'/'; ?>" >
              <li >
                ...
                <span class="" style="font-size:18px; color:white">
                  ...
                  echo "<span class=\"color-alt-grey\" style=\"font-size:16px\">".$this->lang->line('note_for')."</span>".$this->lang->line('note_dev_req');//( BUGFIX mozda je nepotrebna linija)
                  } ?>
                </span>
            ...
            <li >
              <footer class="center" style="padding:5px;border-top:1px solid rgb(154,159,175);border-bottom-left-radius:10px;border-bottom-right-radius:10px;">
               <a href="<?php echo base_url().$language.'/user/profile/notification/'; ?>" class="dark-limegreen-link bold">
      ...
      <?php }?>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" style="z-index:300">
              <li>
         ...
         <li class="visible-sm-block visible-md-block">
            ...
            <?php if($this->user_m->admin_permission(false) OR $this->user_m->admin_permission(false)): ?>
             <li role="separator" class="divider"></li>
             <li>
              <span class="static-link" style="padding:0px;margin:0px;margin-left:10px;">
          ...
          <?php endif; ?>
            <?php if($this->user_m->developer_permission(false)): ?>
            <li>
              <a href="<?php echo base_url().$language.'/developer/category/';  ?>" class="static-link">
                <?php  echo $this->lang->line('nav_mode_dev');  ?>
              </a>
            </li>
          <?php endif; ?>
            ...
            <li>
              <a href="<?php echo base_url().$language.'/user/search/';  ?>" class="static-link">
                 <i class="<?php  echo $this->lang->line('nav_search_icon');  ?>"></i> 
