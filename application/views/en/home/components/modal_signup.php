...
<div class=" signup fade  tab-pane <?php if($modal_signup_active){echo "in active"; } ?>" id="signup" > 
    ...
    <?php echo form_open('en/home/signup', $attributes); ?> 
        ...
        <?php endif; ?>
            ...
            <div class="col-lg-12"><?php echo $recaptcha_html; ?></div> 
            <div class="row col-lg-12">
            <button id="btn-signup" class="btn btn-primary   signup-button col-lg-5 col-lg-offset-3" name="signup-submit" type="submit" value="request" ><?php echo $this->lang->line('create_account'); ?></button> 
                    </div>
            </div>
