...
<div class="tab-content">
    <div class=" signup fade  tab-pane active in" id="signup" > 
    ...
    <?php echo form_open('en/home/signup', $attributes); ?> 
        ...
        <?php endif; ?>
            ...
            <div id="largescreenplace">
            <div id="largescreen"><?php //echo $recaptcha_html; ?> </div>
            </div> 
            <button id="" class="btn btn-primary  pull-right signup-button" name="signup-submit" type="submit" value="request" ><?php echo $this->lang->line('create_account'); ?></button> 
                        
            </div>
        

                         <div class="homepage_signupgroup--social col-lg-8 col-lg-offset-2"> 
            ...
            <!-- START LOGIN TAB  -->
<div class="login fade  tab-pane" id="login"> 
<?php $attributes = array(
            'class' => 'legacy-form',
            'id' => 'legacy-signup');
            ?>
