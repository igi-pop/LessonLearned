...
<div class="col-lg-4 col-lg-offset-1  challenges-list" style="margin-top:25px;margin-Bottom:100px">
      ...
      <a href="<?php echo base_url().$language."/developer/course/lesson/$lesson_current";?>"class="btn btn-primary" style="margin:10px;">
      <?php echo $this->lang->line('lesson_btn_save_exit'); ?> 
...
$(document).ready(function() {
 ...
 console.log(order);
                ...
                $.ajax({
                    url: "http://localhost/codeigniter-lessonlearned/public_html/en/developer/course/lesson/13/order",
                    type: 'POST',
                    data: order,
