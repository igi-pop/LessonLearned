   ...
   <h3 ><?php  echo empty($course->course_id)? 
   $this->lang->line('course_add_new_course') : 
   $this->lang->line('course_edit_course').' <span class="color-green bold">'.$course->title.'</span> 
      <a href="'.base_url().$language.'/developer/course/delete/" class="color-green"><i class="glyphicon glyphicon-trash"></i>
    </a> '; ?>
  </h3>
...
<?php echo form_open_multipart(); ?>
  ...
  <table class="table">
    ...
    <tr>
      ...
      <?php   $options='';
        ...
        endforeach; ?>
      <td><?php echo form_dropdown('category_id', $options, ''); ?></td>
    </tr>
  ...
  <tr>
      ...
      <?php   $dif_option='';
        ...
        endforeach; ?>
      <td><?php echo form_dropdown('difficulty_id', $dif_option, '1'); ?></td>
    </tr>
    ...
    <tr>
      ...
      <td><?php echo form_submit('submit', $this->lang->line('save'), 'class=" col-xs-3 col-xs-offset-4 btn btn-primary"'); ?></td>
    </tr>
...
<?php echo form_open_multipart(); ?>
	...
	<table class="table">
		<tr>
			<td class="hidden-xs"><?php  echo $this->lang->line('course_created');  ?></td>
			<td class="col-xs-12"><?php
			$array=array(
                      'name'        => 'pub_date',
                      'id'          => 'pub_date',
                      'placeholder' => $this->lang->line('course_created_placeholder'),
                      'disabled'	=>	'disabled',
                      'type'        =>  'text',
    ...
    <tr>
      ...
      <td><?php echo form_dropdown('difficulty_id', $dif_option, '1'); ?></td>
		...
		<tr>
			<td class="hidden-xs"></td>
			<td><?php echo form_submit('submit', $this->lang->line('update'), 'class="col-xs-3 col-xs-offset-4 btn btn-primary"'); ?></td>
		</tr>
